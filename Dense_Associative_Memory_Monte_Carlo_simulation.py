...
class Model():
    ...
    def init_spins(self, init_overlap = 0, ori_spins = None):
        ...
        ------
        init_overlap (float):
            Initial overlap between the teacher pattern and the generated patterns.
        ori_spins (float array or None):
            Teacher pattern if generated previously, otherwise None.
        ...
        # Generate the teacher pattern if it is not already generated
    ...
    def krotov_energy_diff(self, overlaps, ori_spins, gen_spins):
        ...
        shifts = -2 * jax.numpy.matmul(ori_spins, gen_spins, precision = jax.lax.Precision.HIGH)/self.N
